CREATE OR REPLACE TRIGGER MFC_ADR_FND_V_IOIT
INSTEAD OF INSERT ON MFC_ADR_FND_V
FOR EACH ROW 
DECLARE
  ...
  THEN -- check for finding in predecessor recon run 
    BEGIN 
      ...
      ( NVL(:new.STD_FND_MIGR_ERROR, 'NULL'), 
        NVL(:new.SRC_CLIENT_ID, 'NULL'), NVL(:new.TRG_CLIENT_ID, 'NULL'), :new.MATCH_CLIENT_ID, NVL(:new.SRC_CLIENT_LAST_NM, 'NULL'), NVL(:new.TRG_CLIENT_LAST_NM, 'NULL'), :new.MATCH_CLIENT_LAST_NM, 
        NVL(:new.SRC_CLIENT_FIRST_NM, 'NULL'), NVL(:new.TRG_CLIENT_FIRST_NM, 'NULL'), :new.MATCH_CLIENT_FIRST_NM, NVL(:new.SRC_CLIENT_CMPNY_NM, 'NULL'), NVL(:new.TRG_CLIENT_CMPNY_NM, 'NULL'), :new.MATCH_CLIENT_CMPNY_NM,
        NVL(:new.SRC_ADR_STREET_NM, 'NULL'), NVL(:new.TRG_ADR_STREET_NM, 'NULL'), :new.MATCH_ADR_STREET_NM, NVL(:new.SRC_ADR_CITY_NM, 'NULL'), NVL(:new.TRG_ADR_CITY_NM, 'NULL'), :new.MATCH_ADR_CITY_NM,
        NVL(:new.SRC_ADR_ZIP_CD, 'NULL'), NVL(:new.TRG_ADR_ZIP_CD, 'NULL'), :new.MATCH_ADR_ZIP_CD, NVL(:new.SRC_ADR_CNTRY_CD, 'NULL'), NVL(:new.TRG_ADR_CNTRY_CD, 'NULL'), :new.MATCH_ADR_CNTRY_CD,
        NVL(:new.SRC_ADR_FULL_STRING, 'NULL'), NVL(:new.TRG_ADR_FULL_STRING, 'NULL'), :new.MATCH_ADR_FULL_STRING
      ) IN 
      ( SELECT 
          NVL(STD_FND_MIGR_ERROR, 'NULL'), 
          NVL(SRC_CLIENT_ID, 'NULL'), NVL(TRG_CLIENT_ID, 'NULL'), MATCH_CLIENT_ID, NVL(SRC_CLIENT_LAST_NM, 'NULL'), NVL(TRG_CLIENT_LAST_NM, 'NULL'), MATCH_CLIENT_LAST_NM, 
          NVL(SRC_CLIENT_FIRST_NM, 'NULL'), NVL(TRG_CLIENT_FIRST_NM, 'NULL'), MATCH_CLIENT_FIRST_NM, NVL(SRC_CLIENT_CMPNY_NM, 'NULL'), NVL(TRG_CLIENT_CMPNY_NM, 'NULL'), MATCH_CLIENT_CMPNY_NM,
          NVL(SRC_ADR_STREET_NM, 'NULL'), NVL(TRG_ADR_STREET_NM, 'NULL'), MATCH_ADR_STREET_NM, NVL(SRC_ADR_CITY_NM, 'NULL'), NVL(TRG_ADR_CITY_NM, 'NULL'), MATCH_ADR_CITY_NM,
          NVL(SRC_ADR_ZIP_CD, 'NULL'), NVL(TRG_ADR_ZIP_CD, 'NULL'), MATCH_ADR_ZIP_CD, NVL(SRC_ADR_CNTRY_CD, 'NULL'), NVL(TRG_ADR_CNTRY_CD, 'NULL'), MATCH_ADR_CNTRY_CD,
